...
import { MaterialFilterSheet, MaterialStat } from "./MaterialFilterSheet";
import { CountryFilterSheet, CountryStat } from "./CountryFilterSheet";
...
export default function FilterView() {
    ...
    const syncFilterOptions = useCallback(() => {
        ...
        if (matched.length === 0 && hasFilters) {
            ...
            const dropOrder: (keyof typeof currentFilters)[] = ["nominal", "name", "material", "country"].filter(
                (k) => k !== last
            );
